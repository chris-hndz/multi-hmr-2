...
public class SMPLXAligner : MonoBehaviour
{
    ...
    void AlignSMPLX()
    {
        foreach (HumanParams human in parameters.humans)
        {
            ...
            if (human.translation_pelvis != null) AdjustPelvisPosition(smplxComponent, human.translation_pelvis);
        }
    }
    ...
    void AdjustPelvisPosition(SMPLX smplxMannequin, float[] pelvisTranslation)
    {
        ...
        smplxMannequin.transform.position += pelvisOffset;
    }
}